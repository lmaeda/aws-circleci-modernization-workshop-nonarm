...
aws_tags={"Name":"DevRel-Amd","Owner":"Angel Rivera","Team":"Dev Rel"}
    ...
    content = json.dumps([{"memory": 3072,
        ...
        "logConfiguration": {
            ...
            "options": {
                ...
                "awslogs-stream-prefix": "devrel-app-amd"
            }
        }
        }])
    return content
...
aws_sg_22 = aws.ec2.SecurityGroup("app-amd-22", name_prefix="app-amd-22-SSH-", vpc_id=vpc_main,
...
aws_sg_443 = aws.ec2.SecurityGroup("app-amd-443", name_prefix="app-amd-443-", vpc_id=vpc_main,
...
aws_sg_80 = aws.ec2.SecurityGroup("app-amd-80", name_prefix="app-amd-80-", vpc_id=vpc_main,
...
aws_cloud_watch_group = aws.cloudwatch.LogGroup("awslogs-app-amd",
...
ecs_service = aws.ecs.Service("app-amd-service",
